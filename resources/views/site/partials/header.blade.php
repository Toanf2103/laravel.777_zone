        ...
        <div class="d-flex align-items-center gap-3 header-search_cart justify-content-center ">
            ...
            <div class="login dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="{{route('site.auth.edit')}}">{{ auth()->guard('user')->user()->full_name }}</a></li>
                    <li><a class="dropdown-item" href="{{route('site.order.menu')}}">Đơn hàng của bạn</a></li>
